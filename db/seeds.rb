...
# runs
bobby1 = Run.create(date: "3/1", name: "Shore Dr.", distance: 4.1, duration: "35:00", pace_per_mile: "8:32", notes: "Sunny outside", number_intervals: 10, interval_length: ":50", rest_between_interval: ":40", month_id: 1, user_id: 1)
bobby2 = Run.create(date: "4/1", name: "Shore Dr.", distance: 4.1, duration: "33:00", pace_per_mile: "8:03", notes: "Fast today", number_intervals: 15, interval_length: ":50", rest_between_interval: ":40", month_id: 2, user_id: 1)
